<?php
    ...
    if ($var00 == 'CA' || $var00 == 'UA' || $var00 == 'DA') {
        ...
        $var01  = setCotizacionTipo($var00, $var01, $var02, $var03);
        $var02  = '';
        $var03  = '';
    }
    ...
    if ($var01 > 0){
        $result = getCotizacionTipoId($var01);

        foreach($result as $data) {
            $var02  = $data['estado_codigo'];
            $var03  = $data['cotizacion_tipo_nombre'];
                    ...
                    <div class="content-wrapper">
                        <div class="page-header">
                            <h1 class="page-title" style="font-size:2.19rem !important;">
                                ...
                                COTIZACI&Oacute;N TIPO MANTENIMIENTO
                            </h1>
                        </div>
                                    ...
                                    <div class="card-body">
                                        <form class="forms-sample" method="get">
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group row">
                                                        <label class="col-12" for="var03"> COTIZACI&Oacute;N TIPO </label>
                                                        <div class="col-12">
                                                            <input type="text" class="form-control" style="text-transform:uppercase;" id="var03" name="var03" value="<?php echo $var03; ?>" placeholder="COTIZACI&Oacute;N TIPO" required <?php echo $readonly; ?>>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            
                                            <a type="button" class="btn btn-light" style="float:right; " href="../pages/cotizaciontipo.php"> Volver </a>
