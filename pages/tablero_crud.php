<?php
    ...
    if ($var00 == 'CA' || $var00 == 'UA' || $var00 == 'DA') {
        ...
        $var01  = setTablero($var00, $var01, $var02, $var03);
        $var02  = '';
        $var03  = '';
    }
    ...
    if ($var01 > 0){
        $result = getTableroId($var01);

        foreach($result as $data) {
            $var02  = $data['estado_codigo'];
            $var03  = $data['tablero_nombre'];
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-12">
                                                            <input type="text" class="form-control" style="text-transform:uppercase;" id="var03" name="var03" value="<?php echo $var03; ?>" placeholder="TABLERO" required <?php echo $readonly; ?>>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            
                                            <a type="button" class="btn btn-light" style="float:right; " href="../pages/tablero.php"> Volver </a>
