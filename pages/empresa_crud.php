<?php
    ...
    if ($var00 == 'CA' || $var00 == 'UA' || $var00 == 'DA') {
        ...
        $var01  = setEmpresa($var00, $var01, $var02, $var03, $var04);
        $var02  = '';
        $var03  = '';
        $var04  = '';
    }
    ...
    if ($var01 > 0){
        $result = getEmpresaId($var01);

        foreach($result as $data) {
            $var02  = $data['estado_codigo'];
            $var03  = $data['empresa_nombre'];
            $var04  = $data['empresa_url'];
                                    ...
                                    <div class="card-body">
                                        <form class="forms-sample" method="get">
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-12">
                                                            <input type="text" class="form-control" style="text-transform:uppercase;" id="var03" name="var03" value="<?php echo $var03; ?>" placeholder="EMPRESA" required <?php echo $readonly; ?>>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group row">
                                                        <label class="col-12" for="var04"> SITIO WEB </label>
                                                        <div class="col-12">
                                                            <input type="text" class="form-control" style="text-transform:uppercase;" id="var04" name="var04" value="<?php echo $var04; ?>" placeholder="SITIO WEB" required <?php echo $readonly; ?>>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            
                                            <a type="button" class="btn btn-light" style="float:right; " href="../pages/empresa.php"> Volver </a>
