    <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        ...
        <div class="navbar-menu-wrapper d-flex align-items-stretch">
            <div class="search-field d-none d-md-block">
                <p style="font-size:2.5rem !important; font-weight:bold; margin:0px; padding:5px;">SISTEMA NAHUEL <span style="font-size:1rem !important;">v1.6<span></p>
            </div>
            <ul class="navbar-nav navbar-nav-right">
                <li class="nav-item nav-profile dropdown">
                    ...
                    <div class="dropdown-menu navbar-dropdown" aria-labelledby="profileDropdown">     
                        <a class="dropdown-item" href="../pages/cotizacion.php">
                            <i class="mdi mdi-cached mr-2 text-success"></i>
                            COTIZACI&Oacute;N
                        </a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="../pages/empresa.php">
                            <i class="mdi mdi-account-convert mr-2 text-info"></i>
                            EMPRESA
                        </a>
                        <a class="dropdown-item" href="../pages/sucursal.php">
                            <i class="mdi mdi-account-convert mr-2 text-info"></i>
                            SUCURSAL
                        </a>
                        <a class="dropdown-item" href="../pages/ciudad.php">
                            <i class="mdi mdi-account-convert mr-2 text-info"></i>
                            CIUDAD
                        </a>
                        <a class="dropdown-item" href="../pages/moneda.php">
                            <i class="mdi mdi-account-convert mr-2 text-info"></i>
                            MONEDA
                        </a>
                        <a class="dropdown-item" href="../pages/tablero.php">
                            <i class="mdi mdi-account-convert mr-2 text-info"></i>
                            TABLERO
                        </a>
                        <a class="dropdown-item" href="../pages/cotizaciontipo.php">
                            <i class="mdi mdi-account-convert mr-2 text-info"></i>
